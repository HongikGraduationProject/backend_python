PROMPT = {
    ...
    또한 title 필드가 공백인 경우 transcript나 description를 참고해서 적절한 제목을 지어줘. 공백이 아니라면 내가 준 json 객체의 title필드를 그대로 적어줘
    단 여기서, 구독자에게 "좋아요" 버튼 누르기를 요청하는 등, 영상의 주제와 관련없는 내용은 요약에서 제외해.
    요약한 후 { "summary" : "요약된 내용", "keywords" : ["키워드1","키워드2","키워드3"], "address" : "주소", "title" : "제목"} 과 같은 형태로 응답해. 
    """,
